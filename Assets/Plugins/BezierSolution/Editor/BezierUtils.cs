...
namespace BezierSolution
{
	public static class BezierUtils
	{
		...
		private static Color NORMAL_END_POINT_COLOR = Color.red;
		private static Color SELECTED_END_POINT_COLOR = Color.red;
		private static Color SELECTED_END_POINT_CONNECTED_POINTS_COLOR = Color.blue;
		...
		public static void DrawBezierPoint( BezierPoint point, int pointIndex, bool isSelected )
		{
			...
			Handles.DotHandleCap( 0, point.precedingControlPointPosition, SceneView.lastActiveSceneView.rotation, HandleUtility.GetHandleSize( point.precedingControlPointPosition ) * END_POINT_CONTROL_POINTS_SIZE, EventType.Repaint );
			Handles.DotHandleCap( 0, point.followingControlPointPosition, SceneView.lastActiveSceneView.rotation, HandleUtility.GetHandleSize( point.followingControlPointPosition ) * END_POINT_CONTROL_POINTS_SIZE, EventType.Repaint );
